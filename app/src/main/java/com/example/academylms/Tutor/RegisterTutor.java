...
import com.example.academylms.Admin.AdminRegister;
...
public class RegisterTutor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(RegisterTutor.this, TutorLogin.class));
            }
        });
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(RegisterTutor.this, "Registration Successful", Toast.LENGTH_SHORT).show();
                    } else {
                        progressDialog.dismiss();
                        Toast.makeText(RegisterTutor.this, "Registration Failed", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void sendUserToMainActivity(String username) {
        Intent intent = new Intent(RegisterTutor.this, TutorDashboard.class);
